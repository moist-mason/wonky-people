...
public class WonkyEntityTypes {
    ...
    public static final RegistryObject<EntityType<Wonky>> WONKY_PERSON = ENTITY_TYPES.register("wonky_person", () ->
            EntityType.Builder.of(Wonky::new, MobCategory.CREATURE).sized(1.0F, 1.0F).build(new ResourceLocation(WonkyPeople.MODID, "wonky_person").toString()));
    public static final RegistryObject<EntityType<HappyWonky>> HAPPY_WONKY = ENTITY_TYPES.register("happy_wonky", () ->
            EntityType.Builder.of(HappyWonky::new, MobCategory.CREATURE).sized(1.0F, 1.0F).build(new ResourceLocation(WonkyPeople.MODID, "happy_wonky").toString()));
