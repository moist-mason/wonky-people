...
public class HappyWonky extends Wonky {
    ...
    public static AttributeSupplier setAttributes() {
        return Animal.createLivingAttributes().add(Attributes.MAX_HEALTH, 25.00).add(Attributes.MOVEMENT_SPEED, 0.6f).build();
    }

    @Override
    public void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(1, new RunInFrontOfPlayerGoal(this, this.getNearestPlayer(), 2.0F));
    }

    public Player getNearestPlayer() {
        return this.getLevel().getNearestPlayer(this, 20);
    }
}
